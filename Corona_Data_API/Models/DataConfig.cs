    ...
    public class DataConfig
    {
        ...
        void GenerateData()
        {
            if (iso_code == "DEU")
            {
                ...
                List<CovidGermanyStates> obj = CovidCSVExtension.FromCSV<CovidGermanyStates>(source, CovidDataManager.csvConfig);
                ...
                List<RKILandkreis> objRKI = CovidCSVExtension.FromCSV<RKILandkreis>(sourceRKI, CovidDataManager.csvConfig);
            ...
            if (iso_code == "USA")
            {
                ...
                List<CovidUSStates> obj = CovidCSVExtension.FromCSV<CovidUSStates>(source, CovidDataManager.csvConfig);
            ...
            if (iso_code == "BRA")
            {
                ...
                List<CovidBrazilStates> obj = CovidCSVExtension.FromCSV<CovidBrazilStates>(source, CovidDataManager.csvConfig);
